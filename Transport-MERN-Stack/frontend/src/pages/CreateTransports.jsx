...
const CreateTransports = () => {
  ...
  const handleSaveBook = () => {
    ...
    axios
      .post('http://localhost:5555/transports', data)
      .then(() => {
        setLoading(false);
        navigate('/');
      })
  ...
  return (
    <div style={{ padding: '1rem' }}>
      <BackButton />
      <h1 style={{ fontSize: '1.5rem', marginTop: '1rem',textDecoration:'bold' }}>CREATE TRANSPORT</h1><br></br>
      {loading ? <Spinner /> : ''}
      <div style={{backgroundColor:'white', display: 'flex', flexDirection: 'column', width: '600px', margin: 'auto' ,border:'3px solid #565ad6',padding:'2%',borderRadius:'10px'}}>
